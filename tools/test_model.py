...
def parse_args():
    ...
    # params of training
    parser.add_argument(
        "--config", dest="cfg", help="The config file.", default='./configs/futr3d/futr3d_cam_radar.yml', type=str)
    parser.add_argument(
        '--batch_size',
        default=2,
        dest='batch_size',
    ...
    parser.add_argument(
        '--model',
        default='new_paddle_cam_radar.pdparams',
        dest='model',
...
def main(args):
    ...
    # paddle.save(state_dict, 'paddle.pdparams')
